...
from bch import translate_message_to_bits_and_split_on_blocks_of_length_k, \
    encode, get_random_number_of_hamming_weight, \
...
def stage_correcting(code, distorted_codewords):
    ...
    for codeword in distorted_codewords:
        message = decode(code.primitive_polynomial, codeword, code.cyclotomic_cosets, code.logarithmic_table,
                         code.power, code.t)
